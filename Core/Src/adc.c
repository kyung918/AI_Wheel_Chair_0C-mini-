...
//차폭 black
float _fWidth_adc_black = 0.73;
//차폭 gold
float _fWidth_adc_gold = 0.6;
//tire radius
float _fWheel_adc = 0.180;
//float _fWheel_adc = 0.085;



#define ADC_REF         3300
#define ADC_RESOLITION   4095
/* USER CODE END 0 */
...
{
   adc.ADC_data[ 0] = adc_dma.ADC_val[ 0] * ADC_REF/ADC_RESOLITION;
   adc.ADC_data[ 1] = adc_dma.ADC_val[ 1] * ADC_REF/ADC_RESOLITION;
